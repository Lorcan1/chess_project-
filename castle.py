...
def castling(moves,move_log,checks):
	...
	if white_left is False and player_turn.board[7][1] ==0 and player_turn.board[7][2] ==0 and player_turn.board[7][3] ==0 and player_turn.board[7][4] == 6:
	...
	if white_right is False and player_turn.board[7][5] == 0 and player_turn.board[7][6] ==0 and player_turn.board[7][4] == 6:
	...
	if black_left is False and player_turn.board[0][1] ==0 and player_turn.board[0][2] ==0 and player_turn.board[0][3] ==0 and player_turn.board[0][4] == 12:
	...
	if black_right is False and player_turn.board[0][5] == 0 and player_turn.board[0][6] ==0:
